...
@Component({
  ...
  templateUrl: './resourcef-details.component.html',
  styleUrls: ['./resourcef-details.component.scss']
})
export class ResourcefDetailsComponent implements OnInit, OnDestroy {
  workshopId!: number;
  resourceId!: number;
  resource!: Resources;
  loading = true;
